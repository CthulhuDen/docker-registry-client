...
$registryFactory      = new \Madkom\DockerRegistryApi\PsrHttpRequestFactory('https://registry.hub.docker.com');
...
$request  = new \Madkom\DockerRegistryApi\Request\ImageTags('library/httpd', 'latest');
